    ...
    <nav className="bg-card border-b border-border">
      <div className="container mx-auto px-4">
        <div className="flex items-center h-16 gap-4">
          ...
          {selectedCase && (
            <div className="flex items-center bg-primary/10 dark:bg-muted border border-primary/20 dark:border-border rounded-lg px-3 py-2 min-w-0 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl ml-auto">
              <div className="flex flex-col min-w-0 w-full">
                {/* Desktop layout */}
                <div className="hidden lg:block">
                  <span className="text-xs font-medium text-primary/80 dark:text-muted-foreground mb-0.5">
                    Valt ärende: {selectedCase.case_number}
                  </span>
                  <div className="min-w-0">
                    <span className="text-sm font-semibold text-primary dark:text-foreground truncate block">
                      {selectedCase.name}
                    </span>
                  </div>
                </div>
                ...
                <div className="hidden sm:block lg:hidden">
                  <div className="flex items-center space-x-2 min-w-0">
                    <span className="text-xs text-primary/70 dark:text-muted-foreground whitespace-nowrap font-medium">
                      {selectedCase.case_number}
                    </span>
                    <span className="text-sm font-semibold text-primary dark:text-foreground truncate flex-1">
                      {selectedCase.name}
                    </span>
                  </div>
                </div>
